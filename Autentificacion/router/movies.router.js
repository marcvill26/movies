...
moviesRouter.post('/',[auth.isAuthenticated, auth.isAdmin], (req,res, next) =>{
...
//put
moviesRouter.put('/:id',[auth.isAuthenticated, auth.isAdmin],(req, res, next) => {
    const id = req.params.id;
...
//delete
moviesRouter.delete('/:id', [auth.isAuthenticated, auth.isAdmin],(req, res, next) => {
    const id = req.params.id;
